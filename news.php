          ...
          <div class="col s12 m12 l9"> <!-- Note that "m8 l9" was added -->
            <!-- Teal page content
              ...
              12-columns-wide on small screens  -->
                <br><br>
       <div class="row">
          <div class="grid-example col s12 m12 l12"><span class="flow-text"><center>All the tweets on Chennai Rainfalls</center> </span>
            </div>
            </div>';

    ?>
   <div><center>
    <a class="twitter-timeline" href="https://twitter.com/hashtag/Chennairains%2C%23Chennairainshelp%2C%23PRAYFORCHENNAI" data-widget-id="672849683216130048">#Chennairains,#Chennairainshelp,#PRAYFORCHENNAI Tweets</a>
<script>
!function(d,s,id)
